...
Java_com_example_capstoneandroid_OCRPredictorNative_init(
...
Java_com_example_capstoneandroid_OCRPredictorNative_forward(
...
Java_com_example_capstoneandroid_OCRPredictorNative_release(
